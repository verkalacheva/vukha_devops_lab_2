...
// Schneller Pixel mit Alpha
int PutPixelAlpha(SDL_Surface * surface, Sint16 x, Sint16 y, Uint32 color, Uint8 alpha);
...
// Ungef¸lltes Viereck mit Alpha
int RectangleRGBA(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a);
// Gef¸lltes Viereck mit Alpha
int FilledRectAlpha(SDL_Surface * surface, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color, Uint8 alpha);
// Gef¸lltes Viereck mit Alpha vom RGBA
int FilledRectAlphaRGBA(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color);

// Ungef¸llter Kreis
int Circle(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 r, Uint32 color);
// Gef¸llter Kreis
...
static SDL_Surface *GfxFont[256];
static Uint32 GfxFontColor[256];

static unsigned char gfxFontdata[FONTDATAMAX] = 
{
